...
public class Money implements Comparable {
	...
	public double getUniversalValue() {
		// @TODO:  Fill in the code for this
		return this.currency.valueInUSD(this.amount);
	...
	public boolean equals(Money other) {
		// @TODO:  Fill in the code for this
		if (this.currency.valueInUSD(this.amount) == other.currency.valueInUSD(other.amount)) {
			 return true;
		}
		else
		{
...
//		System.out.println("vlue 1: " +this.amount);
//	System.out.println("vlue 2: " +other.currency.valueInThisCurrency(other.amount, this.currency));
	...
	public int compareTo(Object other) {
		// @TODO:  Fill in the code for this
		//this.currency.valueInThisCurrency(this.amount, this.currency) other;
		...
		if(other.equals(this)) {
			...
			if(this.currency.valueInUSD(this.amount) < m.currency.valueInUSD(m.amount)) {
